...
<div class="content">
	...
	<!--Основная часть-->
		<div class="main">
			...
			<!--Изображения-->
			<h2>Images</h2>
			<p><img src="<?php bloginfo('template_url'); ?>/images/img1.jpg"><img src="<?php bloginfo('template_url'); ?>/images/img2.jpg"><img src="<?php bloginfo('template_url'); ?>/images/img3.jpg"><img src="<?php bloginfo('template_url'); ?>/images/img4.jpg"></p>
